      ...
      <div className="text-center ">
        ...
        <div className="w-full md:max-w-[784px] mx-auto h-[74px]  flex justify-center items-center mb-10 md:mb-[72px] ">
          <div className="relative w-full border-b border-black">
            {/* <input
              className="w-full h-full py-[25px] text-[#BABABA] text-[16px] outline-none focus:none"
              type="search"
              placeholder="How can we help you?"
            />
            <IoSearch className="cursor-pointer absolute right-0 top-1/2 transform -translate-y-1/2 text-3xl" /> */}
