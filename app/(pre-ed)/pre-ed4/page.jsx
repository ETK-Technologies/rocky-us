...
import { EdPrelander2Script, PreEd4Script } from "@/components/VisiOpt";
...
const SexualHealthFaqs = [
  ...
  },
  {
    ...
    answer:
      "All medications go through extensive clinical trials and quality checks before approval by the U.S. Food and Drug Administration (FDA). The safety and effectiveness of erectile dysfunction medications are well established, which is why they are an excellent treatment option for most men. Our online questionnaire will take into account your personal medical history and determine if these pills are right for you!",
  },
  {
  ...
  },
  {
    ...
    answer:
      "In the United States, erectile dysfunction medications are not available over the counter (OTC) and can only be obtained with a prescription. ED medications sold without a prescription are illegal and could potentially result in harm; ED medications in the counterfeit market do not undergo the correct production, testing, and approval and thus are not safe. Rocky provides access to a licensed health care team so you can be certain that you are getting safe and effective care. Through our online platform, you will be guided through a series of medical questions that are then reviewed by a licensed U.S. physician. Once the medical questionnaire is reviewed, you will be notified if you have been approved, and if so, the appropriate treatment is delivered to your doorstep.",
  },
  {
