        ...
        <div className="md:w-[784px]">
          ...
          <div id="interpretation-and-definitions" className="mb-10 md:mb-14">
            ...
            <div className="text-[16px] mb-4  md:text-[18px] leading-[160%] font-[400]">
              ...
              Rocky Health USA LLC, 850 New Burton Road, Suite 201, Dover, Delaware 19904, USA.
            </div>
            ...
            <div className="text-[16px] mb-4  md:text-[18px] leading-[160%] font-[400]">
              <span className="font-[600] opacity-100 mt-4 mb-4">Country </span>means the United States of America.
            </div>
            ...
            <div className="text-[16px] mb-4  md:text-[18px] leading-[160%] font-[400]">
              <span className="font-[600] opacity-100 mt-4 mb-4">HIPAA </span>means the United States Health Insurance Portability and Accountability Act.
            </div>
            ...
            <div className="text-[16px] mb-4  md:text-[18px] leading-[160%] font-[400]">
              <span className="font-[600] opacity-100 mt-4 mb-4">U.S. Users </span>means users accessing the service from the United States.
            </div>
