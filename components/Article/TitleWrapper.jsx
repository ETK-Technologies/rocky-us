const TitleWrapper = ({ title, loading = false }) => {
  ...
  return (
    <>
      {loading ? (
        <h1 className="mb-3 text:2xl lg:text-3xl mt-4 font-semibold h-16 bg:grey-600"></h1>
      ) : (
        <h1 className="text-[25px] sm:text-2xl lg:text-4xl xl:text-6xl mt-5 font-semibold">
          {displayedTitle}
        </h1>
      )}
    </>
