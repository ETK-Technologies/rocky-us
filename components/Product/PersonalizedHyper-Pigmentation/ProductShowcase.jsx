  ...
  const ingredients = [
    {
      ...
      title: "Tretinoin",
      description:
        "Accelerates cell turnover to shed discoloured skin cells and stimulate collagen production, leading to smooth skin and and even tone.",
      alt: "Tretinoin cream ",
    },
    {
      id: 2,
      ...
      title: "Niacinamide",
      description:
        "Strengthens the skin barrier and helps prevent the transfer of pigment to skin cells, reducing new discolouration.",
      alt: "Niacinamide ",
    },
    {
      id: 3,
      image: "/skin-care-product/cream8.png",
      title: "Azelaic Acid",
      description:
        "Gently clears pores, fades dark spots, and reduces redness, making it effective for both hyperpigmentation and uneven skin tone.",
      alt: "Azelaic Acid ",
    },
    {
      id: 4,
      image: "/skin-care-product/cream7.jpg",
      title: "Kojic acid",
      description:
        "Inhibits melanin production to lighten existing dark spots and brighten overall complexion.",
      alt: "Kojic acid ",
    },
  ];
  ...
  return (
    <section className="bg-white py-14 px-5 md:py-24 md:max-w-[1200px] md:mx-auto relative">
      ...
      <div className="relative">
        ...
        >
          <div className="flex justify-start lg:gap-6 gap-4">
