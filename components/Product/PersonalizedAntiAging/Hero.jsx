...
const Hero = () => {
  ...
  return (
    <section className="bg-[#F5F4EF] w-full">
      <div className="max-w-7xl mx-auto px-5 lg:px-8 pt-[24px] pb-[58px] lg:py-0 flex flex-col lg:flex-row items-center justify-center lg:justify-between lg:h-[720px] relative">
        {/* Desktop Image */}
        <div className="hidden lg:flex lg:justify-start lg:pl-[70px] relative w-[1100px] h-[1100px] mt-28">
          <CustomContainImage
            src="https://myrocky.b-cdn.net/Other%20Images/anti-aging.png"
        ...
        <div className="w-full lg:pl-[40px] text-left max-w-[392px]">
          ...
          <p className="text-[16px] leading-[140%] text-[#000000] md:mb-6 font-normal md:max-w-[349px]">
            ...
            ingredients. This cream smooths fine lines, brightens skin tone, and
            supports collagen production for a visibly youthful, radiant
            complexion
          </p>
          ...
          <div className="flex lg:hidden justify-center mb-6 relative w-full h-[355px] md:my-10">
            <CustomImage
              src="https://myrocky.b-cdn.net/Other%20Images/anti-aging-mobile1.png"
              alt="RX Custom Acne Cream"
              fill
            />
          </div>
          ...
          <div className="flex justify-center lg:justify-start mb-4 w-full lg:min-w-[394px]">
            <Link
              href="/anti-aging-consultation-quiz"
        ...
        {openModalIndex && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#0000004D]">
            ...
            <div className="hidden md:block bg-white rounded-2xl shadow-lg max-w-[640px] w-full p-4 py-10 md:p-[40px] relative m-6">
              <button
                className="absolute top-[10px] md:top-[20px] text-[24px] md:text-[32px] right-[10px] md:right-[20px] shadow-[0px_0px_10px_0px_#00000029] rounded-full w-[32px] h-[32px] flex items-center justify-center hover:text-black  "
            ...
            <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white rounded-t-3xl shadow-lg px-10 py-[64px] max-h-[80vh] overflow-y-auto">
              <div className="flex justify-between items-center mb-6">
                ...
                <button
                  className="absolute top-[20px] text-[24px] md:text-[32px] right-[20px]  shadow-[0px_0px_10px_0px_#00000029] rounded-full w-[32px] h-[32px] flex items-center justify-center hover:text-black  "
                  onClick={() => setOpenModalIndex(false)}
                  aria-label="Close"
                >
                  <IoMdClose className="text-[20px] " />
              ...
              <div className="text-[16px] font-[400] leading-[140%] pr-[20px]">
                <p>
                  For external use only. May cause dryness or irritation. Avoid
                  eyes & sun. Not for use if pregnant or breastfeeding.
                </p>
              </div>
            </div>
          </div>
