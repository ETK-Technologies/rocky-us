...
const Categories = () => {
  return (
    <div className="text-center poppins-font">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-8 lg:my-14 justify-items-center">
        {coverCards &&
          coverCards.map((card) => {
            return (
              <Link
                href={card.link}
                className="relative rounded-xl overflow-hidden shadow-lg w-full h-60 md:h-[275px] max-w-[300px]"
              ...
              >
                ...
                <div className="absolute inset-0 text-start bg-black bg-opacity-40 flex flex-col justify-between py-4 px-2 md:p-4 md:px-[0.8rem]">
                  <h3 className="text-white text-[15px] font-[500]">{card.title}</h3>
