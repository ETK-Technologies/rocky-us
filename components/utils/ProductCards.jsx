    ...
    <>
      <div className=" flex gap-4 flex-nowrap ">
        ...
        >
          ...
          <Link
            href={cards.LeadingProductCard.link}
            className="absolute z-30 bottom-4 md:bottom-6 text-[14px] leading-[19.6px] text-black py-[12px] text-center h-[44px] flex items-center justify-center bg-[#FFFFFF] w-[208px] md:w-[336px] rounded-[64px]"
            prefetch={true}
          >
            Learn More <FaLongArrowAltRight className="ml-2" />
          </Link>
        </div>
