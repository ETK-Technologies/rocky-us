  ...
  return (
    <div className="w-full md:w-[335px] mx-auto md:mb-20 px-6 md:px-0">
      ...
      <div className="product-recommendation-page py-4 pb-32">
        ...
        <div className="text-center mt-4 pb-0 text-[32px] headers-font font-[450] leading-[115%] tracking-[-2%] mb-4">
          We recommend
        </div>
        ...
        <div className="mx-auto w-[335px] mt-4 relative z-10">
          ...
          <div className="bg-white shadow-[0px_0px_16px_0px_rgba(0,0,0,0.25)] p-6 h-[409px] md:h-[415px] w-full md:w-[335px] flex flex-col items-center rounded-2xl relative -mt-[20px] z-20">
            ...
            <div className="flex justify-between items-center mb-4 w-[220px] h-[20px]">
              ...
              <Image
                src="/hair-consultation/trust.png"
                alt="trustpilot"
                width={74}
                height={18}
              />
            ...
            <div className="text-center">
              ...
              <p className="text-[18px] font-medium leading-[140%] tracking-[0%] text-black mb-2">
                {product.price}
              </p>
              {/* Product Description */}
              ...
              <div className="w-full rounded-full">
                <span className="w-[116px] h-[20px] px-[8px] border border-[##E2E2E1] text-[12px] font-normal leading-[140%] tracking-[0%] text-[#098C60] bg-[#F7F7F7] rounded-full py-[2px] text-center">
                  Supply available
                </span>
              </div>
            </div>
        ...
        <div
          className="fixed bottom-[88px] w-[335px] md:w-[520px] h-[48px] -translate-x-2/4 left-2/4 z-20"
          style={{
            background:
              "linear-gradient(180deg, rgba(255, 255, 255, 0.00) 0%, #FFF 34.52%)",
          }}
        ></div>
