...
const ReviewsSection = () => {
  ...
  return (
    <section className="reviews-section" aria-labelledby="reviews-heading">
      <h2
        id="reviews-heading"
        className="max-w-xs md:max-w-[552px] text-center mx-auto text-3xl lg:text-[48px] md:leading-[35px] lg:leading-[48px] font-[550] headers-font"
      >
        Real Results From Real Program Members
      </h2>
      <p className="mt-4 text-[16px] text-[#AE7E56] text-center">
