  ...
  return (
    <>
      {isOpen == true ? (
        ...
        <div className="mt-4">
          <p onClick={() => setIsOpen(true)} className="font-poppins mb-4 cursor-pointer font-normal text-[14px] leading-[140%] tracking-[0] underline decoration-solid decoration-auto decoration-[0] underline-offset-[0]">
            Have a discount code or gift card?
          </p>
          <hr />
        </div>
      )}
