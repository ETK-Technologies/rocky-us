...
const GoodNews = ({ products = [], goTo = "/wl-pre-consultation" }) => {
  const Products =
    products.length > 0
      ? products
      : [
  ...
  return (
    <>
      <div className="mt-16">
        <div
          id="success-message"
          className="p-8 rounded-lg bg-white flex flex-col md:flex-row justify-between items-center"
        >
          <div className="flex flex-col md:flex-row items-start justify-between">
            ...
            <div className="w-full md:w-1/2">
              <div className="space-y-4">
                <BenefitItem
                  bg="bg-[#03A670]"
                  textClassName="font-[POPPINS] font-[550] text-[16px] lg:text-[18px] leadeing-[140%]"
                  text="Free online assessment by a licensed provider"
                />
                <BenefitItem
                  bg="bg-[#03A670]"
                  textClassName="font-[POPPINS] font-[550] text-[16px] lg:text-[18px] leadeing-[140%]"
                  text="Health Canada Approved medications"
                />
                <BenefitItem
                  bg="bg-[#03A670]"
                  textClassName="font-[POPPINS] font-[550] text-[16px] lg:text-[18px] leadeing-[140%]"
                  text="Free, discreet shipping if treatment is approved"
                />
              </div>
              ...
              <div className="mt-[27.5px]">
                ...
                <div className="mt-8 text-[12px] leading-[140%] tracking-[0px] ">
                  *Requires an online consultation with a healthcare provider
                  who will determine if a treatmet is appropriate.
                </div>
              </div>
            </div>
          </div>
