...
import HighesttRate from "../Flows/HighestRate";
...
const chewalisProduct = {
  ...
  pillOptions: {
    "monthly-supply": [
      ...
      { count: 12, genericPrice: 204, brandPrice: 204, variationId: "278229" },
    ],
    "quarterly-supply": [
      { count: 12, genericPrice: 204, brandPrice: 204, variationId: "278230" },
      { count: 24, genericPrice: 399, brandPrice: 399, variationId: "278231" },
      { count: 36, genericPrice: 595, brandPrice: 595, variationId: "219488" },
    ],
  },
};
