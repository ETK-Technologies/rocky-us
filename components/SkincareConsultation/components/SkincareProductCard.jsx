...
const SkincareProductCard = ({ product, onSelect, isSelected }) => {
      ...
      >
        <div className="flex justify-between">
          {product.supplyAvailable ? (
            <>
              <div>
                 {product.id == "522720" && isSelected && (
                  <p className="text-white mb-2 w-fit bg-red-500 rounded-full py-[5px] px-[10px] font-normal text-[8px] md:text-[11px] tracking-tight leading-[140%] animate-pulse">
                    ⚠️ Treatment 3B may irritate sensitive skin. Use with care.
                  </p>
                )}
