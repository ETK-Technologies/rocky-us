...
import { skincareTestimonials as testimonials } from "./data/skincareTestimonials"

export default function SkincareTestimonialSlider() {
                    ...
                    <div className="max-w-xl flex flex-col justify-between  md:max-w-[480px] mt-5 md:mt-0">
                        ...
                        <div className="flex gap-[48px] md:gap-[56px] mt-[16px] md:mt-[32px]">
                            <div className="flex flex-col gap-4">
                                <p className="font-medium text-[#000000CC] text-lg leading-[140%] tracking-[0%] align-middle uppercase">
                                    condition
                                </p>
                                <p className="font-[450] text-[#000000] text-base leading-[140%] tracking-[-2%] align-middle uppercase headers-font">
                                    {condition}
                                </p>
                            </div>
                            <div className="flex flex-col gap-4">
                                <p className="font-medium text-[#0d0b0bcc] text-lg leading-[140%] tracking-[0%] align-middle uppercase">
                                    Treatment
                                </p>
                                <p className="font-[450] text-[#000000] text-base leading-[140%] tracking-[-2%] align-middle uppercase headers-font">
                                    {Treatment}
                        ...
                        <div className="flex gap-3 pt-[32px] md:pt-[40px] justify-center md:justify-start">
                            <button
                                onClick={handlePrev}
                                className={`w-9 h-9 bg-white border rounded-full flex items-center justify-center text-base hover:bg-gray-100 disabled:opacity-40 disabled:cursor-not-allowed ${isFirst ? "border-[#D6D6D6]" : "border-[#212121]"
                                    }`}
                                disabled={isFirst}
                            >
                                <Image
                            ...
                            <button
                                onClick={handleNext}
                                className={`w-9 h-9 bg-white border rounded-full flex items-center justify-center text-base hover:bg-gray-100 disabled:opacity-40 disabled:cursor-not-allowed ${isLast ? "border-[#D6D6D6]" : "border-[#212121]"
                                    }`}
                                disabled={isLast}
                            >
                                <Image
